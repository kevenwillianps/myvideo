                    ...
                    <div class="media-body">
                        ...
                        <h3 class="mb-0 text-center">
                            ...
                            <strong>
                                ...
                                {{ form.show_form ? 'Cancelar Cadastro' : 'Novo Marcador' }}
                            ...
                            <div class="media-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a type="button" class="badge badge-warning mr-1 mt-1 text-white" v-on:click="Form(result.highlighter_id)">
    ...
    export default {
        ...
        methods : {
            ...
            Form(highlighter_id){
                ...
                this.inputs.highlighter_id = highlighter_id;

                /** Envio uma requisição ao meu backend **/
                axios.post('router.php?TABLE=HIGHLIGHTER&ACTION=EDIT_FORM', {inputs: this.inputs})
            ...
            Save(){
                ...
                axios.post('router.php?TABLE=HIGHLIGHTER&ACTION=SAVE', {inputs: this.inputs})
            ...
            List(){
                ...
                /** Envio uma requisição ao meu backend **/
                axios.post('router.php?TABLE=HIGHLIGHTER&ACTION=DATAGRID', {inputs : this.inputs})
            ...
            Delete(){
                ...
                axios.post('router.php?TABLE=HIGHLIGHTER&ACTION=DELETE', {inputs : this.inputs})
