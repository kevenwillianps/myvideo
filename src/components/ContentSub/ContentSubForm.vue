                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" v-if="form.step === 1">
                            ...
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-primary" v-on:click="NextForm()" v-if="inputs.situation_id && inputs.menu_position">
                        ...
                        <div class="col-md-6 text-right" v-if="form.step === 3">
                            ...
                            <button class="btn btn-primary" v-on:click="Save()" v-if="inputs.situation_id && inputs.menu_position && inputs.title && inputs.description">
