                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        ...
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <a class="nav-link" type="button" v-on:click="ShowForm()" v-if="session.user_function_id == 1">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <a class="nav-link" type="button" v-on:click="List()">
                                ...
                                <div class="collapse navbar-collapse" v-bind:id="'MenuContentSubDatagrid_' + result.content_sub_id">
                                    ...
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" type="button" v-on:click="Form(result.content_sub_id)" v-if="session.user_id == result.user_id">
