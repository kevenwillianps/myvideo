<template>
    ...
    <div>
        ...
        <h4>
            ...
            <i class="fas fa-filter mr-1"></i>Categorias
                    ...
                    <div class="media-body">
                        ...
                        <h3 class="mb-0 text-center">
                            ...
                            <strong>
                                ...
                                {{ form.show_form ? 'Cancelar Cadastro' : 'Nova Categoria' }}
        ...
        <div v-show="form.show_form" class="mb-3" v-if="session.user_function_id == 4">
                            ...
                            <div class="media-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a type="button" class="badge badge-warning mr-1 mt-1 text-white" v-on:click="Form(result.content_category_id)">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods : {
            ...
            /** Listagem de Classes **/
            Form(content_category_id){

                /** Deixo a barra de progresso disponivel **/
                this.form.progress_bar = true;
                this.form.show_form    = false;

                this.inputs.content_category_id = content_category_id;

                /** Envio uma requisição ao meu backend **/
                axios.post('router.php?TABLE=CONTENT_CATEGORY&ACTION=EDIT_FORM', {inputs: this.inputs})
            ...
            List(){
                ...
                /** Envio uma requisição ao meu backend **/
                axios.post('router.php?TABLE=CONTENT_CATEGORY&ACTION=DATAGRID', {inputs : this.inputs})
            ...
            Delete(){
                ...
                axios.post('router.php?TABLE=CONTENT_CATEGORY&ACTION=DELETE', {inputs : this.inputs})
