                ...
                <div class="media m-4">
                    ...
                    <div class="media-body">
                        ...
                        <h5 class="mt-2 text-center">
                            ...
                            <router-link v-bind:to="{name : 'content-datagrid', params : {user_id : session.user_id, user_function_id : session.user_function_id}}" class="stretched-link text-decoration-none badge badge-light">
    ...
    export default {
        ...
        methods: {
            ...
            Save() {
                ...
                axios.post('router.php?TABLE=CONTENT&ACTION=CONTENT_SAVE', {
                    inputs: this.inputs
                })
            ...
            SendForm: async(content_id, situation_id, name, pointer, part, length, extension) => {
                ...
                return axios.post('router.php?TABLE=CONTENT_FILE&ACTION=CONTENT_FILE_SAVE', {
                    inputs: {
