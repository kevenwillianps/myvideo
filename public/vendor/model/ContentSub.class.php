...
class ContentSub
{
    ...
    public function all($content_id)
    {
        ...
        $this->sql = "select
                    ...
                    where cs.content_id = :content_id
    ...
    public function save($content_sub_id, $content_id, $content_sub_auxiliary_id, $user_id, $situation_id, $highlighter_id, $menu_position, $url, $title, $title_menu, $description, $content_resume, $content_complete, $date_register, $date_update)
    {
        ...
        if ($this->content_sub_id == 0) {
            ...
            /** Consulta SQL **/
            $this->sql = "INSERT INTO content_sub(content_sub_id, content_id, content_sub_auxiliary_id, user_id, situation_id, menu_position, highlighter_id, url, title, title_menu, description, content_resume, content_complete, date_register, date_update)VALUES(:content_sub_id, :content_id, null, :user_id, :situation_id, :menu_position, :highlighter_id, :url, :title, :title_menu, :description, :content_resume, :content_complete, :date_register, :date_update);";
        } else {

            /** Consulta SQL **/
            $this->sql = "UPDATE content_sub set content_sub_id = :content_sub_id, content_id = :content_id, content_sub_auxiliary_id = null, user_id = :user_id, situation_id = :situation_id, menu_position = :menu_position, highlighter_id = :highlighter_id, url = :url, title = :title, title_menu = :title_menu, description = :description, content_resume = :content_resume, content_complete = :content_complete, date_register = :date_register, date_update = :date_update WHERE content_sub_id = :content_sub_id;";
        }
    ...
    /** Listo a quantidade total de registros **/
    public function getUserContentSub($user_id)
    {
