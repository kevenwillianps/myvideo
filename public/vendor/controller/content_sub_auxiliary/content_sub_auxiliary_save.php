    ...
    if (count($message) > 0) {
       ...
       /** Preparo o formulario para retorno **/
        ...
        try {
           ...
           /** Executo o método **/
            if ($contentSubAuxiliary->save($content_sub_id, $content_id, $content_sub_auxiliary_id, $user_id, $situation_id, $highlighter_id, $menu_position, $url, $title, $title_menu, $description, $content_resume, $content_complete, $date_register, $date_update)) {
                $result = array(

                   "cod" => 1,
                   "content_sub_id" => ($content_sub_id > 0 ? $content_sub_id : $contentSubAuxiliary->getLast()->content_sub_id),
