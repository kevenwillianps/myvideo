...
try {
    ...
    $content_sub_file_id = isset($inputs['inputs']['content_file_id']) ? (int)$main->antiInjection($inputs['inputs']['content_sub_file_id']) : 0;
    ...
    $path = "document/content_sub/{$content_sub_id}/{$year}/{$month}/{$day}/{$extension}";
            ...
            if ($pointer == ($length - 1)) {
                ...
                if (is_file($path . '/' . $name)) {
                    ...
                    $result = array(
                        ...
                        "content_sub_file_id" => $contentSubFile->getLast()->content_sub_file_id
