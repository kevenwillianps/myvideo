...
try {
   ...
   **/
    ...
    $div .= '     <a href="#" class="list-group-item list-group-item-controller" style="border-left: solid 4px #51c28d;" onclick="request(\'TABLE=CONTENT_SUB_FILE&ACTION=DATAGRID\')">';
    $div .= '         <div class="d-flex w-100 justify-content-between">';
    $div .= '             <h6 class="mb-1">listagem de content_sub_file</h6>';
    $div .= '         </div>';
    ...
    $div .= '   <div class="card-body">';
    $div .= '       <form role="form" id="frmContentSubFile">';
    $div .= '           <div class="row">';

    /** Monto meu campo 'content_sub_file_id' **/
    $div .= '               <div class="col-md-12">';
    $div .= '                   <div class="form-group">';
    $div .= '	                    <label for="content_sub_file_id">';
    $div .= '			                content_sub_file_id';
    $div .= '			            </label>';
    $div .= '			            <input id="content_sub_file_id" name="content_sub_file_id" class="form-control" type="text" value="'.@utf8_encode($row->content_sub_file_id).'" >';
    $div .= '	                </div>';
    $div .= '	            </div>';
    ...
    $div .= '               <div class="col-md-12">';
    $div .= '                   <div class="form-group">';
    $div .= '				        <button class="btn btn-outline-primary" type="button" onclick="sendForm(\'#frmContentSubFile\', \'N\')">Salvar <i class="fas fa-paper-plane"></i></button>';
    $div .= '	                </div>';
    $div .= '	            </div>';
    $div .= '           </div>';

    /** Monto meus campos hidden **/
    $div .= '		    <input type="hidden" name="TABLE" value="CONTENT_SUB_FILE"/>';
    $div .= '		    <input type="hidden" name="ACTION" value="SAVE"/>';
    $div .= '			<input type="hidden" name="CONTENT_SUB_FILE_ID" value="'.@$row->content_sub_file_id.'"/>';
