...
try {
   ...
   **/
    ...
    $div .= '            content_sub_file Cadastrados';
    $div .= '        </h5>';
    ...
    $div .= '     <a href="#" class="list-group-item list-group-item-controller" style="border-left: solid 4px #51c28d;" onclick="request(\'TABLE=CONTENT_SUB_FILE&ACTION=FORM\')">';
    $div .= '         <div class="d-flex w-100 justify-content-between">';
    $div .= '             <h6 class="mb-1">Cadastrar Nova content_sub_file</h6>';
    $div .= '         </div>';
