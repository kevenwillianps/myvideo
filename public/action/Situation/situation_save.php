...
try{
   ...
   **/
   ...
   if($situation_id < 0){
       ...
       $error++;
       $message[0] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>situation_id</strong>.<br/>';
   ...
   if($error > 0){
       ...
       $Situation->Save($situation_id, $name, $description, $date_register, $date_update);
