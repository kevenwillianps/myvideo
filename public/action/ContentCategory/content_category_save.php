...
try{
   ...
   **/
   ...
   $content_category_id = isset($inputs['inputs']['content_category_id']) ? (int)$Main->anti_injection($inputs['inputs']['content_category_id']) : 0;
   ...
   if($content_category_id < 0){
       ...
       $error++;
       $message[0] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>content_category_id</strong>.<br/>';
   ...
   if($user_id <= 0){
       ...
       $error++;
       $message[1] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>user_id</strong>.<br/>';
   ...
   if($situation_id <= 0){
       ...
       $error++;
       $message[2] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>situation_id</strong>.<br/>';
   ...
   if(empty($name)){
       ...
       $error++;
       $message[3] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>name</strong>.<br/>';
   ...
   if(empty($description)){
       ...
       $error++;
       $message[4] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>description</strong>.<br/>';
   ...
   if(empty($date_register)){
       ...
       $error++;
       $message[5] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>date_register</strong>.<br/>';
   ...
   if(empty($date_update)){
       ...
       $error++;
       $message[6] = $error. ' - O seguinte campo deve ser preenchido/selecionado <strong>date_update</strong>.<br/>';
